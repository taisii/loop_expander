		...
		},
		{
			...
			inputAsm: &assembler.Assembler{
				Program: []assembler.Instruction{
					...
					{Addr: 4, OpCode: assembler.OpCode{Mnemonic: "jmp", Operands: []string{"InnerLoop"}}},
			...
			expectedAsm: &assembler.Assembler{
				Program: []assembler.Instruction{
					...
					{Addr: 3, OpCode: assembler.OpCode{Mnemonic: "load", Operands: []string{"y", "1"}}},
					{Addr: 4, OpCode: assembler.OpCode{Mnemonic: "jmp", Operands: []string{"InnerLoop"}}},
					{Addr: 5, OpCode: assembler.OpCode{Mnemonic: "jmp", Operands: []string{"OuterLoop_1"}}},
					{Addr: 6, OpCode: assembler.OpCode{Mnemonic: "load", Operands: []string{"x", "0"}}},
					{Addr: 7, OpCode: assembler.OpCode{Mnemonic: "jmp", Operands: []string{"InnerLoop_1"}}},
					{Addr: 8, OpCode: assembler.OpCode{Mnemonic: "load", Operands: []string{"y", "1"}}},
					{Addr: 9, OpCode: assembler.OpCode{Mnemonic: "jmp", Operands: []string{"InnerLoop_1"}}},
					{Addr: 10, OpCode: assembler.OpCode{Mnemonic: "jmp", Operands: []string{"OuterLoop"}}},
				},
				Labels: map[string]int{
					"OuterLoop":   1,
					"OuterLoop_0": 1,
